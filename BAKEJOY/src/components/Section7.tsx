...
import image1 from '../images/image1.png'; // Đường dẫn đúng với ảnh của bạn nhé
...
const Section7 = () => {
  ...
  return (
    <div className="relative flex justify-between items-center h-screen px-10 bg-white text-black font-sans overflow-hidden z-10">
      ...
      <div className="max-w-[700px] flex flex-col justify-center p-8 ml-12 z-10">
        <div className="mb-6">
          <span className="block text-[3.8rem] font-bold mb-2 text-white">
            Ready to taste
          </span>
          <span className="block text-[3.8rem] font-bold mb-2 text-white">
            the magic?
